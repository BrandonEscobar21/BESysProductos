...
namespace BE.SysProductos.DAL
{
    public class CompraDAL
    {
        ...
        public CompraDAL(BESysProductosDbContext sysProductosDB)
        {
        ...
        public async Task<int> AnularAsync(int idCompra)
        {
            ...
            if (compra != null && compra.Estado != (byte)Compra.EnumEstadoComрга.Anulada)
            {
                // Marcar la compra como anulada
                compra.Estado = (byte)Compra.EnumEstadoComрга.Anulada;
