...
namespace BE.SysProductos.WebApp.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        public async Task<ActionResult> ReportesProveedores()
        {
            var proveedores = await _proveedorBL.ObtenerTodosAsync();
        ...
        public async Task<IActionResult> ReporteProveedoresExcel()
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                return File(stream, "aplication/vnd.openxmlformarts-officedocument.spreadsheet.sheet", "ReporteProveedoresExcel.xlsx");
            }
        }
