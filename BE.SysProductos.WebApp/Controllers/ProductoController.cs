...
namespace BE.SysProductos.WebApp.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<ActionResult> ReportesProductos()
        {
            var productos = await _productoBL.ObtenerTodosAsync();
        ...
        public async Task<IActionResult> ReporteProductosExcel()
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                return File(stream, "aplication/vnd.openxmlformarts-officedocument.spreadsheet.sheet", "ReporteProductosExcel.xlsx");
            }
        }
